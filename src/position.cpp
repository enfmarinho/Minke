...
bool Position::insufficient_material() const {
    int piece_count = get_piece_count();
    if (piece_count == 2) {
        return true;
    } else if (piece_count == 3 && (get_material_count(KNIGHT) == 1 || get_material_count(BISHOP) == 1)) {
        return true;
    } else if (piece_count == 4 && (get_material_count(KNIGHT) == 2 ||
                                    (get_material_count(WHITE_BISHOP) == 1 && get_material_count(BLACK_BISHOP) == 1))) {
        return true;
    }

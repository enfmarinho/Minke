...
private:
   ...
   */
  void legal_pawn_moves(const Position &position, MovementList *movement_list);
  /**
   ...
   * @param movement_list movement list to be appended.
   */
  void legal_rook_moves(const Position &position, MovementList *movement_list);
  /**
   * Append "movement_list" with the legal moves for the queen at "position".
   * @param position position of the queen.
   * @param movement_list movement list to be appended.
   */
  void legal_queen_moves(const Position &position, MovementList *movement_list);
  /**
   * Append "movement_list" with the legal moves for the king at "position".
   * @param position position of the king.
   * @param movement_list movement list to be appended.
   */
  void legal_king_moves(const Position &position, MovementList *movement_list);

  Square m_board[NumberOfFiles][NumberOfRanks];
  std::stack<Movement> m_move_history;

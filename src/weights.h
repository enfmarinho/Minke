...
constexpr WeightType BishopPhase = 1;
...
/// doing (index XOR 7).
// clang-format off
constexpr PieceSquareTable MidGamePawnTable = {
    { 0, 0, 0, 0, 0, 0, 0, 0, },
...
constexpr PieceSquareTable EndGamePawnTable = {
    { 0, 0, 0, 0, 0, 0, 0, 0, },
...
constexpr PieceSquareTable MidGameKnightTable = {
...
constexpr PieceSquareTable EndGameKnightTable = {
...
constexpr PieceSquareTable MidGameBishopTable = {
...
constexpr PieceSquareTable EndGameBishopTable = {
...
constexpr PieceSquareTable MidGameRookTable = {
...
constexpr PieceSquareTable EndGameRookTable = {
...
constexpr PieceSquareTable MidGameQueenTable = {
...
constexpr PieceSquareTable EndGameQueenTable = {
...
constexpr PieceSquareTable MidGameKingTable = {
...
constexpr PieceSquareTable EndGameKingTable = {

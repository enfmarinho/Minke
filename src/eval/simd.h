...
inline vepi16 vepi16_load(const vepi16* data) { return _mm256_load_si256(data); }
...
inline vepi16 vepi16_load(const vepi16* data) { return _mm512_load_si512(data); }
...
inline vepi16 vepi16_load(const vepi16* data) { return vld1q_s16(reinterpret_cast<const int16_t*>(data)); }

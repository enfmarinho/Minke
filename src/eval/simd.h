...
inline void vepi16_store(int16_t* dst, const vepi16 vec) { _mm256_store_si256(reinterpret_cast<__m256i*>(dst), vec); }
...
inline void vepi16_store(int16_t* dst, const vepi16 vec) { _mm512_store_si512(reinterpret_cast<__m512i*>(dst), vec); }
...
inline void vepi16_store(vepi16* dst, const vepi16 vec) { vst1q_s16(reinterpret_cast<int16_t*>(dst), vec); }
inline void vepi16_store(int16_t* dst, const vepi16 vec) { vst1q_s16(dst, vec); }

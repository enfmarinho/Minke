...
inline void vepi16_store(int16_t* dst, vepi16 data) { _mm256_store_si256(reinterpret_cast<vepi16*>(dst), data); }
...
inline void vepi16_store(int16_t* dst, vepi16 v) { _mm512_store_si512(dst, v); }
...
inline void vepi16_store(int16_t* dst, int16x8_t v) { vst1q_s16(dst, v); }
